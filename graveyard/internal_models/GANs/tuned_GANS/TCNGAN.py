...
class TCNGAN:
    ...
    def __init__(self, returns_df, asset_name, latent_dim=200, window_size=252, quarter_length=200, 
                 batch_size=120, n_epochs=600, lambda_gp=60, lambda_tail=55, lambda_structure=30, lambda_decay=0.0):
        """
...
class Generator(nn.Module):
    def __init__(self, latent_dim, cond_dim, output_shape=(252,), channels=64, layers=[1, 2, 4, 8, 16, 32]):
