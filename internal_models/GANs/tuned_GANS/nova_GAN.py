...
class NovaGAN:
    def __init__(self, returns_df, asset_name, latent_dim=200, window_size=252, quarter_length=63, batch_size=200, n_epochs=2):
        """
    ...
    def setup(self):
        ...
        self.dataloader = DataLoader(dataset, batch_size=self.batch_size, shuffle=True, drop_last=True)
